...
public class TrainMethodsPrimitive {
    ...
    //создать невозвратный метод printInt,
    // который принимает на вход целое число (int) и печатает в консоль «я получил на вход число » и это число

    public static void printLong(long y){
    ...
    public static void printShort(short s){
        System.out.println("я получил на вход короткое число " + s);
    }
    ...
    public static void printByte(byte by){
        System.out.println("я получил на вход очень короткое число " + by);
    }
    ...
    public static void printBoolean(boolean t){
        System.out.println("я получил на вход булево " + t);
    }
