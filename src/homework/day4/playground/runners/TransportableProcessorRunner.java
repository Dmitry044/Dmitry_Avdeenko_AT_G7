...
public class TransportableProcessorRunner {
    ...
    public static void main(String[] args) {
        ...
        transportableProcessor.runTransportable(transportableMotorbike, 44, 66);

    }
}

//при помощи обьекта класса TransportableProcessor запустить runTransportable
// с каждым из обьектов из предыдущего пункта
//-- в случае, если метод runTransportable не смог принять на вход обьект, закомментировать вызов метода
// и добавить пояснение причины
//-- при помощи обьекта класса TransportableProcessor запустить runTransportable с 2-мя любыми обьектами
// Transportable и точеками перемещения 23 и 242, 93 и 7
